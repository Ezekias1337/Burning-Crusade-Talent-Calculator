        ...
        <div className="row talent-frame ml-3 mr-3">
          <div
            style={{
              backgroundImage: `url(${
                ...
                "/assets/images/talents/Warlock/Background/Affliction.jpg"
              })`,
            }}
          ...
          <div
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL +
                "/assets/images/talents/Warlock/Background/Demonology.jpg"
              })`,
            }}
          ...
          <div
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL +
                "/assets/images/talents/Warlock/Background/Destruction.jpg"
              })`,
            }}
            className="col-sm-12 col-xs-12 col-lg-4 col-md-6 col-xl-4 talent-frame talent-bg"
            id="Col3"
...
export default WarlockComponent;